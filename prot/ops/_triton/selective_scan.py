...
from prot.ops import causal_conv1d_fn
from prot.ops._c import causal_conv1d_cuda
from prot.ops._c import selective_scan_cuda
from prot.ops._triton.layer_norm import _layer_norm_fwd
...
class MambaInnerFn(torch.autograd.Function):
    ...
    def backward(ctx, dout):
        ...
        # The kernel supports passing in a pre-allocated dz (e.g., in case we want to fuse the
        # backward of selective_scan_cuda with the backward of chunk).
        dxz = torch.zeros_like(xz)  # (batch, dim, seqlen)
